...
class GuiCharsPane(Gtk.Alignment):
    ...
    def __init__(self, theBook):
        ...
        self.btnCharsAdd = Gtk.ToolButton(icon_name="list-add-symbolic")
        self.btnCharsDel = Gtk.ToolButton(icon_name="list-remove-symbolic")
        self.btnCharsMvU = Gtk.ToolButton(icon_name="go-up-symbolic")
        self.btnCharsMvD = Gtk.ToolButton(icon_name="go-down-symbolic")
        self.btnCharsAdd.set_tooltip_text("Add New Character")
        self.btnCharsDel.set_tooltip_text("Remove Character")
        self.btnCharsMvU.set_tooltip_text("Move Character Up")
        self.btnCharsMvD.set_tooltip_text("Move Character Down")
        self.btnCharsAdd.set_homogeneous(True)
        self.btnCharsDel.set_homogeneous(True)
        self.btnCharsMvU.set_homogeneous(True)
        self.btnCharsMvD.set_homogeneous(True)
