...
class GuiBookPane(Gtk.Alignment):
    ...
    def __init__(self, theBook):
        ...
        self.btnChaptersMvU = Gtk.ToolButton()
        self.btnChaptersMvD = Gtk.ToolButton()
        self.btnChaptersAdd.set_label("Add")
        self.btnChaptersDel.set_label("Remove")
        self.btnChaptersNum.set_label("Re-number")
        self.btnChaptersMvU.set_label("Move Up")
        self.btnChaptersMvD.set_label("Move Down")
        ...
        self.btnChaptersMvU.set_homogeneous(False)
        self.btnChaptersMvD.set_homogeneous(False)
